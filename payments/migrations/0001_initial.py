    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_content_type', to='contenttypes.ContentType')),
                ('plate_content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plate_content_type', to='contenttypes.ContentType')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
